          ...
          <div className="max-w-[320px] w-full mx-auto">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="inline-flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="h-3 w-3 rounded border-2 border-orange-300 accent-[#ff9500]" />
                <span className="font-medium text-slate-700 text-sm">Remember me</span>
              </label>
              <button type="button" className="font-medium text-[#ff9500] hover:text-orange-600 text-sm">
                Forgot Password?
              </button>
            </div>
            <Button type="submit" className="w-full bg-[#ff9500] hover:bg-orange-600 text-white font-semibold py-1.5 text-sm">
              Login
            </Button>
          </form>
