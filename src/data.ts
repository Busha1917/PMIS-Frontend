...
export const events: EventRecord[] = [
  {
    ...
    coOrganizer: 'Ministry of Innovation and Technology',
    eventMode: 'Hybrid',
    partnerParticipants: [
      {
        id: 'pp-1',
    ...
    eaiiParticipants: [
      {
        ...
        email: 'abebe.k@eaii.gov.et',
      },
    ],
    estimatedBudget: 50000,
    actualBudget: 48000,
    fundingScore: 8.5,
    keyDiscussions: 'Ethical AI Deployment and regional compute resources.',
    agreementsReached: 'Collaborate on a joint AI policy framework.',
    actionPoints: 'Draft the policy framework by July 2025.',
    objectivesAchieved: 'Successful networking and research sharing.',
    recommendations: 'Expand compute lab space for next year.',
    attachmentsAgenda: 'agenda_summit_2025.pdf',
    attachmentsAttendanceSheet: 'attendance_summit_2025.xlsx',
    attachmentsPresentations: 'ai_ethics_slides.pptx',
  },
  {
    id: 'evt-002',
    no: 2,
    ...
    actualBudget: 14000,
    fundingScore: 9.0,
    keyDiscussions: 'Edge Computing and Autonomous Navigation algorithms.',
    agreementsReached: 'Top 3 teams to receive internship offers.',
    actionPoints: 'Prepare certificates and prize disbursement.',
  },
  {
    id: 'evt-003',
    no: 3,
    ...
    keyTopicsDiscussed: 'Amharic and Tigrinya LLM fine-tuning, compute requirements.',
    opportunitiesIdentified: 'Joint fellowship grants, compute infrastructure assistance.',
    visitAgreementsReached: 'Provide API access to experimental translation endpoints.',
    followUpActions: 'Set up bi-weekly research sync calls.',
    visitAttachmentsSchedule: 'visit_schedule_google.pdf',
    visitAttachmentsMinutes: 'meeting_minutes_20_05.docx',
  },
  {
    id: 'evt-004',
    no: 4,
  ...
  },
  {
    id: 'evt-005',
    no: 5,
    title: 'Visit of AI Startup Delegation',
    type: 'site visit',
    date: '2025-03-26T11:00',
    venue: 'AI Startup Incubation Hub',
    status: 'Approved',
    category: 'Visit',
    ...
    hostOrganization: 'Ethiopian AI Institute',
    visitingOrganization: 'Tech Addis Ecosystem',
    visitLocations: 'Incubation Center',
    purposeOfVisit: 'Explore tech stack support and mentorship agreements.',
  },
  {
    id: 'evt-006',
    no: 6,
  ...
  },
  {
    id: 'evt-007',
    no: 7,
    title: 'Courtesy Visit to AAU President',
    type: 'courtesy visit',
    date: '2025-05-15T09:00',
    venue: 'AAU President Office',
    status: 'Approved',
    category: 'Visit',
    visitType: 'courtesy visit',
    visitCategory: 'Internal',
    visitDate: '2025-05-15',
    hostOrganization: 'Addis Ababa University',
    visitingOrganization: 'Ethiopian AI Institute',
    purposeOfVisit: 'Introduce new AI postgraduate internship framework.',
  },
  {
    id: 'evt-008',
    no: 8,
  ...
  },
  {
    id: 'evt-010',
    no: 10,
    title: 'Joint AI Research Workshop',
    type: 'Workshop',
