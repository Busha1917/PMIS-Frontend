        ...
        <div className="rounded-[2rem] border border-slate-200/70 bg-slate-50/90 p-6 shadow-[0_24px_80px_rgba(15,23,42,0.08)] backdrop-blur-sm">
          <div className="mb-8 flex flex-col gap-4 rounded-[2rem] border border-slate-200/80 bg-white p-6 shadow-sm sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <h1 className="mt-3 text-3xl font-semibold tracking-tight text-slate-950">{formState.title || 'Event Preview'}</h1>
          ...
          <div className="grid gap-6 xl:grid-cols-3">
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-5 flex items-center justify-between">
                <p className="text-sm font-semibold uppercase tracking-[0.24em] text-slate-900">Event Details</p>
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-5 flex items-center justify-between">
                <p className="text-sm font-semibold uppercase tracking-[0.24em] text-slate-900">Partner Representatives</p>
                <span className="block h-1.5 w-16 rounded-full bg-orange-400" />
              </div>
              <div className="space-y-4 text-sm text-slate-700">
                {partnerReps.map((rep) => (
                  <div key={rep.name} className="flex justify-between border-b border-slate-200 pb-3 last:border-none last:pb-0">
                    <span>{rep.name}</span>
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-5 flex items-center justify-between">
                <p className="text-sm font-semibold uppercase tracking-[0.24em] text-slate-900">EAII Representatives</p>
                <span className="block h-1.5 w-16 rounded-full bg-orange-400" />
              </div>
              <div className="space-y-4 text-sm text-slate-700">
                {eaiiReps.map((rep) => (
          ...
          <div className="grid gap-6 xl:grid-cols-2">
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-5 flex items-center justify-between">
                <p className="text-sm font-semibold uppercase tracking-[0.24em] text-slate-900">Agreement Reached</p>
                <span className="block h-1.5 w-16 rounded-full bg-orange-400" />
              </div>
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
              <div className="mb-5 flex items-center justify-between">
                <p className="text-sm font-semibold uppercase tracking-[0.24em] text-slate-900">Action Points</p>
                <span className="block h-1.5 w-16 rounded-full bg-orange-400" />
              </div>
              <p className="text-sm leading-7 text-slate-700">{summaryText}</p>
            </div>
