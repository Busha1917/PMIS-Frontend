          ...
          <div className="grid gap-6 xl:grid-cols-2">
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="text-sm leading-7 text-slate-700">
                This partnership opportunity represents a strategic alignment. Discussions are
                ongoing regarding scopes of work, milestones, and collaborative divisions. Further
                details will be updated as conversations mature.
              </p>
            </div>
          </div>
        </div>
