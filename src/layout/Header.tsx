...
const PAGE_LABELS: Record<AdminPage, string> = {
  ...
  'events-director-general': 'Events — Director General',
  'events-assigned-person': 'Events — Assigned Person',
  ...
  partners: 'Partners',
  'partners-officer': 'Partners — Officer',
  'partners-ke-director': 'Partners — Verification',
  'partners-division-director': 'Partners — Approval',
  ...
  'collaboration-grants-officer': 'Funding & Grants — Officer',
  'collaboration-grants-division-director': 'Funding & Grants — Division Director',
  'collaboration-contributions': 'Collaboration — Contributions',
  'collaboration-contributions-officer': 'Resource Contributions — Officer',
  'collaboration-contributions-division-director': 'Resource Contributions — Division Director',
  'kpi-monitoring': 'KPI Monitoring',
  'kpi-monitoring-officer': 'KPI Monitoring — Officer',
  'kpi-monitoring-division-director': 'KPI Monitoring — Division Director',
  baseData: 'Base Data',
  users: 'Users',
  roles: 'Roles',
